...
public interface ReservationMapper {
    ...
    //예약 번호 조회
    @Select("select reservation_id from reservation where member_id = #{memberId} and item_id = #{itemId} and start_time = #{startTime} and reservation_date = #{reservationDate}")
